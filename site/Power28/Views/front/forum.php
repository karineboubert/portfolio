...
<div class="col-lg-12 nomargin d-flex justify-content-end">
    ...
    <p class="d-flex justify-content-end">
        <a class="blackButton bold" data-toggle="collapse" href="#collapseExample" aria-expanded="false"
            ...
            <div class="column">
                ...
                <form action="index.php?page=topic_list" method="post" class="pt-5 offset-1 col-10">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" value="<?php echo $user['pseudo']; ?>"
...
<?php require 'partials/navForum.php'; ?><br/><br/>
    ...
    <?php foreach ($topics as $topic): ?>
        ...
        <div class="row topic borderBlack padding d-flex align-items-center nomargin ">
            ...
            <div class="col-md-4 col-lg-3 nomargin d-flex justify-content-center">
                <a class="blackButton bold" href="index.php?page=topic&topic_id=<?php echo $topic['id']; ?>"> Voir la
                    discussion </a>
            </div>
