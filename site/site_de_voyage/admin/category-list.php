			...
			<div class="row my-3 index-content">
				...
				<section class="col-9">
					<header class="pb-4 d-flex justify-content-between">
						...
						<a class="btn btn blue" href="category-form.php">Ajouter une catégorie</a>
					</header>
					...
					<table class="table table-striped">
						...
						<tbody>
							...
							<tr>
								...
								<td><?php echo htmlentities($category['name_category']); ?></td>
								<td>
									<a href="category-form.php?category_id=<?php echo $category['id']; ?>&action=edit" class="btn btn black">Modifier</a>
									<a onclick="return confirm('Are you sure?')" href="category-list.php?category_id=<?php echo $category['id']; ?>&action=delete" class="btn btn blue">Supprimer</a>
								</td>
							</tr>
