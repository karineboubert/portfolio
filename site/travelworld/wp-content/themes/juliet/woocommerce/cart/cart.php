...
<form class="woocommerce-cart-form" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
                ...
                foreach ( WC()->cart->get_cart() as $cart_item_key => $cart_item ) {
                    ...
                    if ( $_product && $_product->exists() && $cart_item['quantity'] > 0 && apply_filters( 'woocommerce_cart_item_visible', true, $cart_item, $cart_item_key ) ) {
                        ...
                        <tr class="woocommerce-cart-form__cart-item <?php echo esc_attr( apply_filters( 'woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key ) ); ?>">
                            ...
                            <td class="table-cart-delete product-remove">
                                <?php
                            ...
                            <td class="table-cart-thumb product-thumbnail">
                                <?php
                            ...
                            <td class="table-cart-name product-name" data-title="<?php esc_attr_e( 'Product', 'juliet' ); ?>">
                                <?php
                                    if ( ! $product_permalink ) {
                            ...
                            <td class="table-cart-qty product-quantity" data-title="<?php esc_attr_e( 'Quantity', 'juliet' ); ?>">
                                <?php
	...
	<div class="row">
		...
		<div class="col-sm-6 col-md-8">
			<p class="text-right">
				<input type="submit" class="btn btn-border-dark btn-cart" name="update_cart" value="<?php esc_attr_e( 'Update cart', 'juliet' ); ?>" />
			</p>
		</div>
