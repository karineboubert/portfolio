...
--
-- Hôte : localhost:3306
-- Généré le :  lun. 14 jan. 2019 à 14:43
...
--
-- Structure de la table `kp28_category_faq`
--

CREATE TABLE `kp28_category_faq` (
  `id` int(11) NOT NULL,
  `name_category` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Déchargement des données de la table `kp28_category_faq`
--

INSERT INTO `kp28_category_faq` (`id`, `name_category`) VALUES
(1, 'PRISE EN MAIN'),
(2, 'FONCTIONNALITÉS'),
...
--
-- Structure de la table `kp28_comment`
--

CREATE TABLE `kp28_comment` (
  `id` int(11) NOT NULL,
...
--
-- Déchargement des données de la table `kp28_comment`
--

INSERT INTO `kp28_comment` (`id`, `topic_id`, `user_id`, `comment`, `author`, `created_at`, `is_published`) VALUES
...
--
-- Structure de la table `kp28_faq`
--

CREATE TABLE `kp28_faq` (
  `id` int(11) NOT NULL,
...
--
-- Déchargement des données de la table `kp28_faq`
--

INSERT INTO `kp28_faq` (`id`, `category_id`, `question`, `answer`, `is_published`) VALUES
...
--
-- Structure de la table `kp28_purchase`
--

CREATE TABLE `kp28_purchase` (
  `id` int(11) NOT NULL,
  `user_id` int(11) NOT NULL,
...
--
-- Déchargement des données de la table `kp28_purchase`
--

INSERT INTO `kp28_purchase` (`id`, `user_id`, `price_power28`, `price_training`, `price_filesMaker`) VALUES
(1, 1, '1200', '600', 0),
(2, 2, '1200', '0', 0);
...
--
-- Structure de la table `kp28_topic`
--

CREATE TABLE `kp28_topic` (
  `id` int(11) NOT NULL,
  `question` text NOT NULL,
...
--
-- Déchargement des données de la table `kp28_topic`
--

INSERT INTO `kp28_topic` (`id`, `question`, `content`, `author`, `created_at`, `is_published`) VALUES
...
--
-- Structure de la table `kp28_topic_category`
--

CREATE TABLE `kp28_topic_category` (
  `id` int(11) NOT NULL,
  `topic_id` int(11) NOT NULL,
  `category_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Déchargement des données de la table `kp28_topic_category`
--

INSERT INTO `kp28_topic_category` (`id`, `topic_id`, `category_id`) VALUES
(1, 1, 1),
(2, 2, 5),
(3, 3, 4),
(4, 4, 1),
...
--
-- Structure de la table `kp28_user`
--

CREATE TABLE `kp28_user` (
  `id` int(10) NOT NULL,
...
--
-- Déchargement des données de la table `kp28_user`
--

INSERT INTO `kp28_user` (`id`, `firstname`, `lastname`, `company_name`, `pseudo`, `email`, `password`, `address`, `postcode`, `city`, `mobile`, `is_admin`) VALUES
...
--
-- Index pour la table `kp28_category_faq`
--
ALTER TABLE `kp28_category_faq`
  ADD PRIMARY KEY (`id`);

--
-- Index pour la table `kp28_comment`
--
ALTER TABLE `kp28_comment`
  ADD PRIMARY KEY (`id`);

--
-- Index pour la table `kp28_faq`
--
ALTER TABLE `kp28_faq`
  ADD PRIMARY KEY (`id`);

--
-- Index pour la table `kp28_purchase`
--
ALTER TABLE `kp28_purchase`
  ADD PRIMARY KEY (`id`);

--
-- Index pour la table `kp28_topic`
--
ALTER TABLE `kp28_topic`
  ADD PRIMARY KEY (`id`);

--
-- Index pour la table `kp28_topic_category`
--
ALTER TABLE `kp28_topic_category`
  ADD PRIMARY KEY (`id`);

--
-- Index pour la table `kp28_user`
--
ALTER TABLE `kp28_user`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT pour la table `kp28_category_faq`
--
ALTER TABLE `kp28_category_faq`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
-- AUTO_INCREMENT pour la table `kp28_comment`
--
ALTER TABLE `kp28_comment`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
--
-- AUTO_INCREMENT pour la table `kp28_faq`
--
ALTER TABLE `kp28_faq`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
--
-- AUTO_INCREMENT pour la table `kp28_purchase`
--
ALTER TABLE `kp28_purchase`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT pour la table `kp28_topic`
--
ALTER TABLE `kp28_topic`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
-- AUTO_INCREMENT pour la table `kp28_topic_category`
--
ALTER TABLE `kp28_topic_category`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
-- AUTO_INCREMENT pour la table `kp28_user`
--
ALTER TABLE `kp28_user`
